...
pump_run = 'myuser/feeds/ar-hq-trailer-park-well.ar-hq-trailer-park-water-well-pump'
well_pump_i = 'myuser/feeds/ar-hq-trailer-park-well.ar-hq-trailer-park-water-well-pump-i'
drywell_delay = 'myuser/feeds/ar-hq-trailer-park-well.ar-hq-trailer-park-dry-well-delay'
sys_run = 'myuser/feeds/ar-hq-trailer-park-well.ar-hq-trailer-park-water-well-system-run'
dw_time_r = 'myuser/feeds/ar-hq-trailer-park-well.ar-hq-trailer-park-water-well-dry-well-time-remaining'
dw_count = 'myuser/feeds/ar-hq-trailer-park-well.ar-hq-trailer-park-water-well-dry-well-count'
well_ps = 'myuser/feeds/ar-hq-trailer-park-well.ar-hq-trailer-park-water-well-pressure-switch'
...
while True:
        if client.connected:
            ...
            time.sleep(60)  # Add a delay to avoid flooding the server with requests
